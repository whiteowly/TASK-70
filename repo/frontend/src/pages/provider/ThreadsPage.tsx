...
function ProviderThreadsPage() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["provider-threads"],
    queryFn: messageApi.providerThreads,
  });
        ...
        <div className="space-y-2">
          {threads.map((thread) => (
            <Link
              ...
              to={`/provider/messages/${thread.thread_id}`}
...
export default ProviderThreadsPage;
